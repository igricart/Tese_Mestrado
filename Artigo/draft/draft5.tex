...
\item {\bf Semi-Global Stability Properties}:  it is not a restrictive assumption consider the existence of a  class $\mathcal{K}_{\infty}$ function $\Psi(\cdot)$ and an positive constant $k_\psi$ such that 
%
...
In the present case, random parametric errors in plant values from \cite{Richter2015}, such as center of gravity, inertia matrix and link length won't differ by more than $10\%$ from the real one. A white gaussian noise has also been added to the systems output, representing a disturbance needed to be compensated. That will help to illustrate an HGO variable gain application.

Simulation results from HGO design with static gain are shown in Figs.~\ref{fig:hip}-~\ref{fig:dankle}. The parameters used are $l_1=2$, $l_2=6$ and $\mu=\bar{\mu}=0.001$.

In Fig.~\ref{fig:hip}-Fig.~\ref{fig:ankle}, the desired, estimated and true state trajectory are depicted. It can be seen an estimation converges of approximately 7 ms and overshoots in position estimation due to zero initial condition.

\begin{figure}[h!]
	\begin{center}
	%\includegraphics[width = \columnwidth]{Figs/q_hip_mu_1e-03.eps}
	\includegraphics[width = 7cm]{Figs/q_hip_mu_1e-03.eps}
	\caption{ Simulation results from a desired hip movement, the controlled plant state and the estimated state from the HGO with constant parameter $\mu=0.001$. The right plot shows the signals behaviors from the first 40ms of simulation}
	\label{fig:hip}
	\end{center}
\end{figure}
%
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/q_thigh_mu_1e-03.eps}
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/q_knee_mu_1e-03.eps}
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/q_ankle_mu_1e-03.eps}
...
%
%
The corresponding hip, thigh, knee and ankle velocities are illustrated in Fig.~\ref{fig:dhip}-Fig.~\ref{fig:dankle}. The RMSE for tracking error in Table.~\ref{table:RMSE_track} shows that velocities in knee and ankle joints require a faster control law to track, mainly because of higher frequency components which also contribute to a worst state estimation in HGO.

When implementing HGO, it is important to take in consideration peak values occurring due to its inner characteristics. In order to avoid that, both velocity and control signals had saturation values as depicted in Fig.~\ref{fig:dankle} and Fig.~\ref{fig:u_comparison}.

It can be seen that the HGO with static gain and PID control approach were suitable for the task.
%
%Simulations were also conducted using HGO with variable gain to evaluate its performance in the presence of noise and parametric uncertainties. Fig. ~\ref{fig:mu_comparison} - Fig.\ref{q_error_comparison} show 
%
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/dq_hip_mu_1e-03.eps}
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/dq_thigh_mu_1e-03.eps}
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/dq_knee_mu_1e-03.eps}
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/dq_ankle_mu_1e-03.eps}
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/mu_comparison.eps}
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/SNR_comparison.eps}
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[width = 6cm]{Figs/q_error_comparison.eps}
