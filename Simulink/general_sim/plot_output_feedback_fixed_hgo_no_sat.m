...
for j=1:size(k_noise,2)
    ...
    sim('simulation_hgo_no_sat_2017a.slx',1);
    save(['no_sat_output_feedback_' num2str(sprintf('%.0d',Mu_hgo)) '_' num2str(k_noise(j)) '.mat']);
...
fname1 = '/home/ignacio/Documents/Msc/Tese_Mestrado/Simulink/general_sim/figs/no_sat_fixed_hgo';
fname2 = '/home/igricart/Documents/Tese_Mestrado/Simulink/general_sim/figs/no_sat_fixed_hgo';
...
% Plot 1.1 Joints
i = 1;
load(['no_sat_output_feedback_4e-04_' num2str(k_noise(j)) '.mat']);
...
load(['no_sat_output_feedback_1e-03_' num2str(k_noise(j)) '.mat']);
subplot(3,2,3);
plot(q_ref.Time, q_ref.Data(:,i),'k', q.Time, q.Data(:,i),q_hat.Time, q_hat.Data(:,i),'--');
title('(c)', 'FontSize', 10);
grid on; grid minor;
...
load(['no_sat_output_feedback_2e-03_' num2str(k_noise(j)) '.mat']);
subplot(3,2,5);
plot(q_ref.Time, q_ref.Data(:,i),'k', q.Time, q.Data(:,i),q_hat.Time, q_hat.Data(:,i),'--');
title('(e)', 'FontSize', 10);
grid on; grid minor;
...
saveas(f_hip,fullfile(fname,['no_sat_output_feedback_' num2str(k_noise(j)) '_hip']),'epsc');
...
saveas(f_hip_track_error,fullfile(fname,['no_sat_output_feedback_track_error_' num2str(k_noise(j)) '_hip']),'epsc');
...
plot(q_est_error.Time, q_est_error.Data(:,i))
xlabel(['Time(s)']);
ylabel('$\tilde{x}_{1} (m)$', 'Interpreter','latex');
lgd = legend({'4e-4','10e-4','19e-4'},'Location','northeast');
lgd.FontSize = 8;
...
plot(dq_est_error.Time, dq_est_error.Data(:,i))
xlabel(['Time(s)']);
ylabel('$\tilde{x}_{5} (m/s)$', 'Interpreter','latex');
...
saveas(f_hip_est_error,fullfile(fname,['no_sat_output_feedback_est_error_' num2str(k_noise(j)) '_hip']),'epsc');
...
saveas(f_hip_u,fullfile(fname,['no_sat_output_feedback_control_signal' num2str(k_noise(j)) '_hip']),'epsc');
...
saveas(f_thigh,fullfile(fname,['no_sat_output_feedback_' num2str(k_noise(j)) '_thigh']),'epsc');
...
saveas(f_thigh_track_error,fullfile(fname,['no_sat_output_feedback_track_error_' num2str(k_noise(j)) '_thigh']),'epsc');
...
plot(q_est_error.Time, q_est_error.Data(:,i)*converter)
xlabel(['Time(s)']);
ylabel('$\tilde{x}_{2}(deg)$', 'Interpreter','latex');
lgd = legend({'4e-4','10e-4','19e-4'},'Location','northeast');
lgd.FontSize = 8;
...
plot(dq_est_error.Time, dq_est_error.Data(:,i)*converter)
xlabel(['Time(s)']);
ylabel('$\tilde{x}_{6} (deg/s)$', 'Interpreter','latex');
...
saveas(f_thigh_est_error,fullfile(fname,['no_sat_output_feedback_est_error_' num2str(k_noise(j)) '_thigh']),'epsc');
...
saveas(f_thigh_u,fullfile(fname,['no_sat_output_feedback_control_signal' num2str(k_noise(j)) '_thigh']),'epsc');
...
saveas(f_knee,fullfile(fname,['no_sat_output_feedback_' num2str(k_noise(j)) '_knee']),'epsc');
...
plot(q_error.Time, q_error.Data(:,i)*converter)
xlabel(['Time(s)']);
ylabel('$e_3 (deg)$', 'Interpreter','latex');
lgd = legend({'4e-4','10e-4','19e-4'},'Location','northeast');
lgd.FontSize = 8;
...
saveas(f_knee_track_error,fullfile(fname,['no_sat_output_feedback_track_error_' num2str(k_noise(j)) '_knee']),'epsc');
...
plot(q_est_error.Time, q_est_error.Data(:,i)*converter)
xlabel(['Time(s)']);
ylabel('$\tilde{x}_{3}(deg)$', 'Interpreter','latex');
lgd = legend({'4e-4','10e-4','19e-4'},'Location','northeast');
lgd.FontSize = 8;
...
plot(dq_est_error.Time, dq_est_error.Data(:,i)*converter)
xlabel(['Time(s)']);
ylabel('$\tilde{x}_{7}(deg/s)$', 'Interpreter','latex');
...
saveas(f_knee_est_error,fullfile(fname,['no_sat_output_feedback_est_error_' num2str(k_noise(j)) '_knee']),'epsc');
...
plot(u.Time, u.Data(:,i))
xlabel(['Time (s)']);
ylabel('$u_3 (Nm)$', 'Interpreter','latex');
lgd = legend({'4e-4','10e-4','19e-4'},'Location','northeast');
lgd.FontSize = 8;
...
saveas(f_knee_u,fullfile(fname,['no_sat_output_feedback_control_signal' num2str(k_noise(j)) '_knee']),'epsc');
...
saveas(f_ankle,fullfile(fname,['no_sat_output_feedback_' num2str(k_noise(j)) '_ankle']),'epsc');
...
plot(q_error.Time, q_error.Data(:,i)*converter)
xlabel(['time (s)'])
ylabel('$e_4 (deg)$', 'Interpreter','latex');
lgd = legend({'4e-4','10e-4','19e-4'},'Location','northeast');
lgd.FontSize = 8;
...
saveas(f_ankle_track_error,fullfile(fname,['no_sat_output_feedback_track_error_' num2str(k_noise(j)) '_ankle']),'epsc');
...
plot(q_est_error.Time, q_est_error.Data(:,i)*converter)
xlabel(['Time(s)']);
ylabel('$\tilde{x}_{4} (deg)$', 'Interpreter','latex');
lgd = legend({'4e-4','10e-4','19e-4'},'Location','northeast');
lgd.FontSize = 8;
...
plot(dq_est_error.Time, dq_est_error.Data(:,i)*converter)
xlabel(['Time(s)']);
ylabel('$\tilde{x}_{8} (deg/s)$', 'Interpreter','latex');
...
saveas(f_ankle_est_error,fullfile(fname,['no_sat_output_feedback_est_error_' num2str(k_noise(j)) '_ankle']),'epsc');
...
plot(u.Time, u.Data(:,i))
xlabel(['Time (s)']);
ylabel('$u_4 (Nm)$', 'Interpreter','latex');
lgd = legend({'4e-4','10e-4','19e-4'},'Location','northeast');
lgd.FontSize = 8;
...
saveas(f_ankle_u,fullfile(fname,['no_sat_output_feedback_control_signal' num2str(k_noise(j)) '_ankle']),'epsc');
