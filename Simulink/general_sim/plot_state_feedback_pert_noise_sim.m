...
fname = '/home/ignacio/Documents/Msc/Tese_Mestrado/Simulink/general_sim/figs';
    ...
    saveas(f_hip,fullfile(fname,['state_feedback_' num2str(k_noise) '_hip']),'epsc');
    ...
    saveas(f_thigh,fullfile(fname,['state_feedback_' num2str(k_noise) '_thigh']),'epsc');
    ...
    saveas(f_knee,fullfile(fname,['state_feedback_' num2str(k_noise) '_knee']),'epsc');
    ...
    saveas(f_ankle,fullfile(fname,['state_feedback_' num2str(k_noise) '_ankle']),'epsc');
