...
Another change is regarding the dirty derivative. A model reference has been designed to have a filtered gait data and its derivatives, performing a better aprroximation than the dirty derivative approach.

In order to define the minimum and maximum HGO gain, trials have been made in which the conclusion is ... the gain should be inbetween $0.5e-3$ and $1.4e-3$.
